...
else
{
	...
	$result = mysql_query("DELETE FROM HTML5Games WHERE owner = '$owner' AND id = '$gameID'") or die(mysql_error());
	
	echo "Your game has been deleted. Never to return. It is gone. Forever. Poof.";
