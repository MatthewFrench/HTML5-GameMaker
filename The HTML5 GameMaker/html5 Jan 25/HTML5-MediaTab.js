...
function mediaHit(mediaNum) {
	...
	if (mediaArray.length > 0) {
		if (mediaArray[selectedMedia].isImage) {
			mediaViewer.innerHTML = "Name: " + mediaArray[selectedMedia].name+"</br>" + "Src: " + mediaArray[selectedMedia].source + '</p><img style="padding:5px;" src="'+ mediaArray[selectedMedia].source +'" alt="Your Image" />';
		} else {
